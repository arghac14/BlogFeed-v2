            ...
            <div className="row">
                <div className="card post-neu" style={{borderRadius: "20px 20px 20px 20px"}}>
                    ...
                    <small className="text-muted cat">
                          Posted by <Link to={'/user/'+id}>{writer}</Link>
                        </small>
                    ...
                    <div className="card-footer text-muted d-flex justify-content-between bg-transparent border-top-0">
                        <div className="views postbig" style={{fontWeight: "lighter", fontSize: "18px", textAlign: "justify", textJustify: "auto"}}>
