...
@heroku-cli/plugin-local/7.42.0 darwin-x64 node-v10.18.1
$ heroku --help [COMMAND]
USAGE
  $ heroku COMMAND
...
...
_See code: [src/commands/local/index.ts](https://github.com/heroku/cli/blob/v7.42.0/src/commands/local/index.ts)_
...
_See code: [src/commands/local/run.ts](https://github.com/heroku/cli/blob/v7.42.0/src/commands/local/run.ts)_
...
_See code: [src/commands/local/version.ts](https://github.com/heroku/cli/blob/v7.42.0/src/commands/local/version.ts)_
<!-- commandsstop -->
